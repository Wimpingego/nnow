...
public class ModConfigs {
    ...
    public static ConfigValue<Integer> CLAY_DUST;
    ...
    private static void initConfig()  { 
        ...
        CLAY_DUST = COMMON_BUILDER.comment().define("Clay balls", 4); 
		...
		EMERALD_TIER_TOOL_DURABILITY_MODIFIER = COMMON_BUILDER.comment().define("Emerald Tier durability modifier",2342);	
		COMMON_BUILDER.pop();
		COMMON_BUILDER.pop();
