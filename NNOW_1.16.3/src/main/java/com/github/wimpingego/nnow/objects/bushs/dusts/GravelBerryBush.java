...
public class GravelBerryBush extends BaseBerryBush
{
	   int Dust = ModConfigs.GRAVEL_DUST.get();
	   
	   public GravelBerryBush(Block.Properties properties) {
	      super(properties);
	      this.setDefaultState(this.stateContainer.getBaseState().with(AGE, Integer.valueOf(0)));
	   }

	   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
		      return new ItemStack(BlockList.GRAVEL_BERRY_BUSH.get());
		   }
	   ...
	   @Override
		public ActionResultType onBlockActivated(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
		      ...
		      if (!flag && p_225533_4_.getHeldItem(p_225533_5_).getItem() == Items.BONE_MEAL) {
		    	 ...
		    	 int j = Dust + p_225533_2_.rand.nextInt(2);
		         spawnAsEntity(p_225533_2_, p_225533_3_, new ItemStack(ItemList.GRAVEL_DUST.get(), j + (flag ? 1 : 0)));
