...
public class TradesRegistration {
    ...
    public static void registerTrades(VillagerTradesEvent event){
        ...
        if (event.getType() == VillagerProfessions.BANKER)
        {
            ...
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 25, 0.2F).setPrice(Items.COPPER_INGOT, 1,1).setPrice2(Items.STONE, 8,8).setForSale(Items.COPPER_ORE, 1, 2).build()));
        ...
        if (event.getType() == VillagerProfessions.BEEKEEPER)
        {
            ...
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 25, 0.05F).setEmeraldPrice(1,8).setForSale(Items.BONE_MEAL, 1, 32).build()));
            ...
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 15, 0.05F).setPrice(Items.HONEY_BOTTLE, 8,16).setForSale(Items.EMERALD, 1, 8).build()));
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 25, 0.05F).setEmeraldPrice(16,32).setForSale(Items.BEE_NEST, 1, 1).build()));
           	
           	event.getTrades().get(4).add((new RandomTradeBuilder(64, 15, 0.05F).setPrice(Items.HONEY_BLOCK, 8,16).setForSale(Items.EMERALD, 1, 8).build()));
        ...
        if (event.getType() == VillagerProfessions.OLD_DERPY)
        {
            ...
            event.getTrades().get(5).add((new RandomTradeBuilder(64, 10, 0.05F).setEmeraldPrice(8,16).setForSale(Items.NETHERITE_INGOT, 1,1).build())); 
        }  
        ...
        if (event.getType() == VillagerProfessions.MONSTER_TRAPPER)
        {
            ...
            event.getTrades().get(1).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.ZOGLIN_SPAWN_EGG, 1, 1).build()));
            ...
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.STRIDER_SPAWN_EGG, 1, 1).build()));
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.CREEPER_SPAWN_EGG, 1, 1).build()));
            ...
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.HOGLIN_SPAWN_EGG, 1, 1).build()));
            ...
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.ZOMBIFIED_PIGLIN_SPAWN_EGG, 1, 1).build()));
            ...
            event.getTrades().get(4).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.PIGLIN_SPAWN_EGG, 1, 1).build()));  
        ...
        if (event.getType() == VillagerProfessions.NETHER_TRADER)
        {
            ...
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(4,16).setForSale(Items.WARPED_NYLIUM, 8, 16).build()));
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(4,16).setForSale(Items.CRIMSON_NYLIUM, 8, 16).build()));
            ...
            event.getTrades().get(2).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(1,16).setForSale(Items.SOUL_SOIL, 8, 16).build()));
            ...
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(4,16).setForSale(Items.BASALT, 8, 16).build()));
            event.getTrades().get(3).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(4,16).setForSale(Items.BLACKSTONE, 8, 16).build()));
            ...
            event.getTrades().get(5).add((new RandomTradeBuilder(64, 30, 0.05F).setEmeraldPrice(8,32).setForSale(Items.CRYING_OBSIDIAN, 1, 8).build()));
            event.getTrades().get(5).add((new RandomTradeBuilder(64, 30, 0.05F).setPrice(Items.EMERALD, 32,64).setPrice2(Items.WITHER_SKELETON_SPAWN_EGG, 1,1).setForSale(Items.WITHER_SKELETON_SKULL, 1, 1).build()));
        } 
    }
}
