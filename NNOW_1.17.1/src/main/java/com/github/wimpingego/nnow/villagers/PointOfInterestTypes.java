...
{
    public static final PoiType OLD_DERPY = null;
    public static final PoiType BANKER = null;
    public static final PoiType BEEKEEPER = null;
    public static final PoiType MONSTER_TRAPPER = null;
    public static final PoiType END_TRADER = null;
    public static final PoiType SEA_TRADER = null;
    public static final PoiType SEA_FISHERMAN = null;
    public static final PoiType NETHER_TRADER = null;
    public static final PoiType INGOT_TRADER = null;
    
    @SubscribeEvent
    public static void registerPointOfInterestTypes(Register<PoiType> event)
    {	
        IForgeRegistry<PoiType> registry = event.getRegistry();
