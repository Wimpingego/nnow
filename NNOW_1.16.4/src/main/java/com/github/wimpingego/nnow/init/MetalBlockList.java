...
public class MetalBlockList {
	...
	//Metal Bushes
	public static final RegistryObject<Block> COPPER_BERRY_BUSH = NO_ITEM_BLOCK.register("copper_berry_bush",() -> new CopperBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> NICKEL_BERRY_BUSH = NO_ITEM_BLOCK.register("nickel_berry_bush",() -> new NickelBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> SILVER_BERRY_BUSH = NO_ITEM_BLOCK.register("silver_berry_bush",() -> new SilverBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> URANIUM_BERRY_BUSH = NO_ITEM_BLOCK.register("uranium_berry_bush",() -> new UraniumBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> LEAD_BERRY_BUSH = NO_ITEM_BLOCK.register("lead_berry_bush",() -> new LeadBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> ALUMINUM_BERRY_BUSH = NO_ITEM_BLOCK.register("aluminum_berry_bush",() -> new AluminumBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));
	public static final RegistryObject<Block> TIN_BERRY_BUSH = NO_ITEM_BLOCK.register("tin_berry_bush",() -> new TinBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> OSMIUM_BERRY_BUSH = NO_ITEM_BLOCK.register("osmium_berry_bush",() -> new OsmiumBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));
	public static final RegistryObject<Block> BISMUTH_BERRY_BUSH = NO_ITEM_BLOCK.register("bismuth_berry_bush",() -> new BismuthBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));
	public static final RegistryObject<Block> ZINC_BERRY_BUSH = NO_ITEM_BLOCK.register("zinc_berry_bush",() -> new ZincBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));	
	public static final RegistryObject<Block> PLATINUM_BERRY_BUSH = NO_ITEM_BLOCK.register("platinum_berry_bush",() -> new PlatinumBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));
	public static final RegistryObject<Block> IRIDIUM_BERRY_BUSH = NO_ITEM_BLOCK.register("iridium_berry_bush",() -> new IridiumBerryBush(AbstractBlock.Properties.from(Blocks.SWEET_BERRY_BUSH).tickRandomly()));
}
