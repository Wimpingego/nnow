...
public class ModConfigs {
    ...
    public static BooleanValue IGNORE_HUNGER;

    public static BooleanValue CAKE_RESET;
    public static ConfigValue<List<? extends String>> RESET_ITEM;

    public static BooleanValue EAT_NETHER_CAKE;
    public static ConfigValue<List<? extends String>> NETHER_CAKE_REFILL_ITEMS;
    public static BooleanValue NETHER_CAKE_LOGIC;

    public static BooleanValue EAT_END_CAKE;
    public static ConfigValue<List<? extends String>> END_CAKE_REFILL_ITEMS;

    public static BooleanValue EAT_OVERWORLD_CAKE;
    public static ConfigValue<List<? extends String>> OVERWORLD_CAKE_REFILL_ITEMS;
    ...
    private static class Cakes
    {
    	Cakes(ForgeConfigSpec.Builder builder)
    	{
			builder.comment("Configuration related to the cakes").push("Cakes");
			builder.push("General");
			IGNORE_HUNGER = builder.comment("Defines if the cakes usage requires hunger, when set to true it ignores hunger [default: true]").define("Ignore Hunger", true);
            CAKE_RESET = builder.comment("Defines if the cakes teleportation point can be reset with the reset item [default: false]").define("Reset Cakes", false);
            ...
            RESET_ITEM = builder.comment("Defines the item needed to reset the cakes teleportation point [default: minecraft:milk_bucket]").defineList("Reset Items", Arrays.asList(resetItem), o -> (o instanceof String));

            builder.pop();
            builder.comment("Nether cake settings").push("Nether Cake");
            EAT_NETHER_CAKE = builder.comment("Defines if the Nether Cake gets partly consumed when eaten [default: true]").define("Eat Nether Cake", true);
            ...
            NETHER_CAKE_REFILL_ITEMS = builder.comment("Set the refill items used by Nether Cake (Only change if you know what you're doing) [modid:itemname].").defineList("Nether Cake Refill Items", Arrays.asList(netherItems), o -> (o instanceof String));
            NETHER_CAKE_LOGIC = builder.comment("Defines if the Nether Cake should teleport the player 1x1 (Use this if you're replacing the Nether dimension with one that is 1x1) [default: false].").define("Nether Cake Logic", false);

            builder.pop();
            builder.comment("End cake settings").push("End Cake");
            EAT_END_CAKE = builder.comment("Defines if the End Cake gets partly consumed when eaten [default: true]").define("Eat End Cake", true);
            ...
            END_CAKE_REFILL_ITEMS = builder.comment("Set the refill items used by End Cake (Only change if you know what you're doing) [modid:itemname].").defineList("End Cake Refill Items", Arrays.asList(endItems), o -> (o instanceof String));

            builder.pop();
            builder.comment("Overworld cake settings").push("Overworld Cake");
            EAT_OVERWORLD_CAKE = builder.comment("Defines if the Overworld Cake gets partly consumed when eaten [default: true]").define("Eat Overworld Cake", true);
            ...
            OVERWORLD_CAKE_REFILL_ITEMS = builder.comment("Set the refill items used by Overworld Cake (Only change if you know what you're doing) [modid:itemname].") .defineList("Overworld Cake Refill Items", Arrays.asList(overworldItems), o -> (o instanceof String));
            builder.pop();
        }
    }     
