...
public class ModBlockColors
{
	...
	public static void registerBlockColorHandler(final ColorHandlerEvent.Block event)
	{
		...
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.ACACIA_CAULDRON.get());
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.BIRCH_CAULDRON.get());
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.DARK_OAK_CAULDRON.get());
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.JUNGLE_CAULDRON.get());
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.OAK_CAULDRON.get());
		blockColors.register(new WoodenCauldron.ColorHandler(), BlockList.SPRUCE_CAULDRON.get());
	}
	...
	public static void registerItemColorHandler(final ColorHandlerEvent.Item event)
	{
		...
		itemColors.register(itemBlockColourHandler, BlockList.ACACIA_CAULDRON.get());
		itemColors.register(itemBlockColourHandler, BlockList.BIRCH_CAULDRON.get());
		itemColors.register(itemBlockColourHandler, BlockList.DARK_OAK_CAULDRON.get());
		itemColors.register(itemBlockColourHandler, BlockList.JUNGLE_CAULDRON.get());
		itemColors.register(itemBlockColourHandler, BlockList.OAK_CAULDRON.get());
		itemColors.register(itemBlockColourHandler, BlockList.SPRUCE_CAULDRON.get());
