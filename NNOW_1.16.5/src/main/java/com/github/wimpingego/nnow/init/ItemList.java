...
import com.github.wimpingego.nnow.objects.items.pokingsticks.*;
...
public class ItemList {
	...
	public static final RegistryObject<Item> GLOWSTONE_BERRY = ITEMS.register("glowstone_berry", () -> new BlockItem(BlockList.GLOWSTONE_BERRY_BUSH.get(), new Item.Properties().group(NNOW.NNOW_TAB).food(FoodList.BERRY)));
	...
	public static final RegistryObject<Item> NETHERITE_BERRY = ITEMS.register("netherite_berry", () -> new BlockItem(BlockList.NETHERITE_BERRY_BUSH.get(), new Item.Properties().group(NNOW.NNOW_TAB).food(FoodList.BERRY).isImmuneToFire()));
	...
	public static final RegistryObject<Item> GLOWSTONE_NUGGET = ITEMS.register("glowstone_nugget", () -> new Item(new Item.Properties().group(NNOW.NNOW_TAB)));
	...
	public static final RegistryObject<Item> NETHERITE_NUGGET = ITEMS.register("netherite_nugget", () -> new Item(new Item.Properties().group(NNOW.NNOW_TAB).isImmuneToFire()));
	...
	//Other items
	public static final RegistryObject<Item> W_SHEAR = ITEMS.register("wooden_shears", () -> new WoodenShears(new Item.Properties().group(NNOW.NNOW_TAB)));
	public static final RegistryObject<Item> G_SHEAR = ITEMS.register("golden_shears", () -> new WoodenShears(new Item.Properties().group(NNOW.NNOW_TAB)));
	public static final RegistryObject<Item> D_SHEAR = ITEMS.register("diamond_shears", () -> new WoodenShears(new Item.Properties().group(NNOW.NNOW_TAB)));
	public static final RegistryObject<Item> N_SHEAR = ITEMS.register("netherite_shears", () -> new WoodenShears(new Item.Properties().group(NNOW.NNOW_TAB).isImmuneToFire()));
	...
	public static final RegistryObject<Item> N_HAMMER = ITEMS.register("netherite_hammer", () -> new NetheriteHammer(ItemTier.NETHERITE, 7, -3.1f, new Item.Properties().group(NNOW.NNOW_TAB).isImmuneToFire()));
	...
	public static final RegistryObject<Item> N_SPADE = ITEMS.register("netherite_spade", () -> new NetheriteSpade(ItemTier.NETHERITE, 2.0f, -3f, new Item.Properties().group(NNOW.NNOW_TAB).isImmuneToFire()));
	...
	public static final RegistryObject<Item> STONE_POKING_STICK = ITEMS.register("stone_poking_stick", () -> new StonePokingStick(new Item.Properties().group(NNOW.NNOW_TAB)));
	public static final RegistryObject<Item> IRON_POKING_STICK = ITEMS.register("iron_poking_stick", () -> new IronPokingStick(new Item.Properties().group(NNOW.NNOW_TAB)));
	...
	public static final RegistryObject<Item> BUNDLE_LEAVES = ITEMS.register("bundle_leaves", () -> new Item(new Item.Properties().group(NNOW.NNOW_TAB)));
	
	//public static final RegistryObject<Item> NETHER_CAKE_ITEM = ITEMS.register("nether_cake", () -> new BlockItem(BlockList.NETHER_CAKE.get(), new Item.Properties().group(NNOW.NNOW_TAB)));
	//public static final RegistryObject<Item> END_CAKE_ITEM = ITEMS.register("end_cake", () -> new BlockItem(BlockList.END_CAKE.get(), new Item.Properties().group(NNOW.NNOW_TAB)));
	//public static final RegistryObject<Item> OVERWORLD_CAKE_ITEM = ITEMS.register("overworld_cake", () -> new BlockItem(BlockList.OVERWORLD_CAKE.get(), new Item.Properties().group(NNOW.NNOW_TAB)));
	...
	public static final RegistryObject<ArmorItem> NC_HELMET = ITEMS.register("clear_netherite_helmet",() -> new ArmorItem(ModArmorMaterials.NC, EquipmentSlotType.HEAD, new Item.Properties().group(NNOW.NNOW_TAB).isImmuneToFire()));
