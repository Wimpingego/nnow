...
public class PointOfInterestTypes
{
    ...
    {	
        ...
        registry.register(VillagerUtil.pointOfInterestType("end_trader", VillagerUtil.getAllStates(BlockList.END_TRADER.get()), 1, 1).setRegistryName(NNOW.MOD_ID, "end_trader"));
        ...
        registry.register(VillagerUtil.pointOfInterestType("ingot_trader", VillagerUtil.getAllStates(BlockList.INGOT_FURNACE.get()), 1, 1).setRegistryName(NNOW.MOD_ID, "ingot_trader"));
       
//        registry.register(VillagerUtil.pointOfInterestType("old_derpy", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "old_derpy"));
//        registry.register(VillagerUtil.pointOfInterestType("beekeeper", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "beekeeper"));
//        registry.register(VillagerUtil.pointOfInterestType("end_trader", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "end_trader"));
//        registry.register(VillagerUtil.pointOfInterestType("sea_trader", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "sea_trader"));
//        registry.register(VillagerUtil.pointOfInterestType("sea_fisherman", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "sea_fisherman"));
//        registry.register(VillagerUtil.pointOfInterestType("nether_trader", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "nether_trader"));
//        registry.register(VillagerUtil.pointOfInterestType("banker", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "banker"));
//        registry.register(VillagerUtil.pointOfInterestType("monster_trapper", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "monster_trapper"));
//        registry.register(VillagerUtil.pointOfInterestType("ingot_trader", VillagerUtil.getAllStates(Blocks.ACACIA_DOOR), 1, 1).setRegistryName(NNOW.MOD_ID, "ingot_trader"));
