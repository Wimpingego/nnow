...
public class BlockList {
	...
	public static final RegistryObject<Block> BANKER_POI = BLOCKS.register("banker_poi",() -> new BeekeeperBlock<Object>(Block.Properties.from(Blocks.OAK_PLANKS).harvestTool(ToolType.AXE)));
	public static final RegistryObject<Block> END_TRADER = BLOCKS.register("end_trader",() -> new EndTraderBlock(Block.Properties.from(Blocks.OAK_PLANKS).harvestTool(ToolType.AXE)));
	...
	public static final RegistryObject<Block> BEEKEEPER_BLOCK = BLOCKS.register("beekeeper_block",() -> new BeekeeperBlock<Object>(Block.Properties.from(Blocks.BOOKSHELF).harvestTool(ToolType.AXE)));
	...
	public static final RegistryObject<Block> SEA_TRADER_POI = BLOCKS.register("sea_trader",() -> new DoubleHighBlock(Block.Properties.from(Blocks.OAK_PLANKS).harvestTool(ToolType.AXE)));
	...
	//POI
	public static final RegistryObject<Block> INGOT_FURNACE = NO_ITEM_BLOCK.register("ingot_furnace",() -> new WaterWell(Block.Properties.from(Blocks.IRON_BLOCK)));
