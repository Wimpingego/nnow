...
public class HammerBase extends PickaxeItem {
	...
	public boolean canHarvestBlock(BlockState state) {
		...
		return super.canHarvestBlock(state) || state.isIn(BlockTags.SAND) || state.isIn(Tags.Blocks.DIRT) || state.isIn(Tags.Blocks.GRAVEL) || state.getBlock() == Blocks.SOUL_SAND;
	}
