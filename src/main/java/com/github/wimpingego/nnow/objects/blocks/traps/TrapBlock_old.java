...
public class TrapBlock_old<IBlockState> extends Block implements IExplosionResistant{
	...
	public TrapBlock_old(Properties properties) {
		 super(properties);
	}
	...
	public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
		if (entityIn instanceof LivingEntity && entityIn.getType() != EntityType.PLAYER
			...
			entityIn.attackEntityFrom(DamageSource.CRAMMING, 25);
		}
	}
}
