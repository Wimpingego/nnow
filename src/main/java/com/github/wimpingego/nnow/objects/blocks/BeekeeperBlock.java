...
public class BeekeeperBlock<IBlockState> extends Block {
	public static final VoxelShape NORTHS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	public static final VoxelShape WESTS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	public static final VoxelShape SOUTHS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	public static final VoxelShape EASTS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	public static final VoxelShape UPS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	public static final VoxelShape DOWNS = makeCuboidShape(0.1D*16, 0.1D*16, 0.1D*16, 0.9D*16, 0.98D*16, 0.9D*16);
	...
	public BeekeeperBlock(Properties properties) {
		super(properties);
}
