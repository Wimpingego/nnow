package com.github.wimpingego.nnow.objects.blocks.bushs;
...
public class RedstoneBerryBush extends BushBlock implements IGrowable
{
	public static final IntegerProperty AGE = BlockStateProperties.AGE_0_3;
	   ...
	   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
	      return new ItemStack(BlockList.REDSTONEBERRY_BUSH.get());
	   }
