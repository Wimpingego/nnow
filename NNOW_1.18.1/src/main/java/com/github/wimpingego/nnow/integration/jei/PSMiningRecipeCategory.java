...
public class PSMiningRecipeCategory implements IRecipeCategory<CraftingRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(NNOW.MODID, "ps_mining");
    ...
    public PSMiningRecipeCategory(IGuiHelper guiHelper) {
    ...
    public Component getTitle() {
        return new TextComponent("From Mining");
    }
