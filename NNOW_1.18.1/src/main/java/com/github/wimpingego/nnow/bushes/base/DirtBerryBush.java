...
{
	   int Nugget = Configs.DIRT_DUST.get();

	   public DirtBerryBush(Properties properties) {
	      super(properties);
	      this.registerDefaultState(this.stateDefinition.any().setValue(AGE, Integer.valueOf(0)));
	   }

	   public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
		      return new ItemStack(Registration.DIRT_BERRY_BUSH.get());
		   }
	   ...
	   @Override
		public InteractionResult use(BlockState p_225533_1_, Level p_225533_2_, BlockPos p_225533_3_, Player p_225533_4_, InteractionHand p_225533_5_, BlockHitResult p_225533_6_) {
		      ...
		      if (!flag && p_225533_4_.getItemInHand(p_225533_5_).getItem() == Items.BONE_MEAL) {
		         ...
		         popResource(p_225533_2_, p_225533_3_, new ItemStack(Registration.DIRT_DUST.get(), j + (flag ? 0 : 0)));
