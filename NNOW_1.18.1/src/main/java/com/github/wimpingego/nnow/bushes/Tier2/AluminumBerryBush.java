package com.github.wimpingego.nnow.bushes.Tier2;
...
public class AluminumBerryBush extends BaseBush
{
	private final BushType type;
	   
	   public AluminumBerryBush(Block.Properties properties, BushType type) {
		   super(properties);
		   this.type = type;
