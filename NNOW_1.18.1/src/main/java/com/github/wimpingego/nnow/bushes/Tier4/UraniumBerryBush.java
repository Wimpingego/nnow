package com.github.wimpingego.nnow.bushes.Tier4;
...
public class UraniumBerryBush extends BaseBush
{
	private final BushType type;
	   
	   public UraniumBerryBush(Block.Properties properties, BushType type) {
		   super(properties);
		   this.type = type;
