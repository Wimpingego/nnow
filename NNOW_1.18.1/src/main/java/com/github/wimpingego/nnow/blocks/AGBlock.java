...
public class AGBlock extends Block {
    ...
    public boolean canSustainPlant(BlockState state, BlockGetter world, BlockPos pos, Direction facing, net.minecraftforge.common.IPlantable plantable) {
        ...
        if (plant.getBlock() == Blocks.CACTUS)
            return state.is(Blocks.CACTUS) || this == Registration.AGG_BLOCK.get()
                    || this == Registration.AGRS_BLOCK.get() || this == Registration.AGS_BLOCK.get();
        ...
        if (net.minecraftforge.common.PlantType.DESERT.equals(type)) {
            return this == Registration.AGG_BLOCK.get() || this == Registration.AGRS_BLOCK.get() || this == Registration.AGS_BLOCK.get();
...
//	         return Block.hasSolidSide(state, world, pos, Direction.UP);
            ...
            boolean isBeach = this == Registration.AGG_BLOCK.get() || this == Registration.AGRS_BLOCK.get() || this == Registration.AGS_BLOCK.get();
