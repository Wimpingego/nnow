package com.github.wimpingego.nnow.bushes.Tier5;
...
public class NetheriteBerryBush extends BaseBush
{
	private final BushType type;
	   
	   public NetheriteBerryBush(Block.Properties properties, BushType type) {
		   super(properties);
		   this.type = type;
