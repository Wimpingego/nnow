...
public class MetalItemList {
	...
	//Villager Item
	public static final RegistryObject<Item> INGOT_TRADER_POI = ITEMS.register("ingot_trader_poi", () -> new BlockItem(BlockList.INGOT_TRADER_POI.get(), new Item.Properties().group(NNOW.NNOW_TAB)));
}
