...
public class BlockList {
	...
	public static final RegistryObject<Block> BEEKEEPER_POI = BLOCKS.register("beekeeper_poi",() -> new TableBlock<Object>(Block.Properties.from(Blocks.BOOKSHELF).harvestTool(ToolType.AXE)));
	public static final RegistryObject<Block> SEA_FISHERMAN_POI = BLOCKS.register("sea_fisherman_poi",() -> new DoubleHighBlock(Block.Properties.from(Blocks.IRON_BLOCK).harvestTool(ToolType.AXE)));
	...
	public static final RegistryObject<Block> NETHER_TRADER_POI = BLOCKS.register("nether_trader_poi",() -> new DoubleHighBlock(Block.Properties.from(Blocks.NETHERRACK).harvestTool(ToolType.AXE)));
	...
	//POI
	public static final RegistryObject<Block> INGOT_TRADER_POI = NO_ITEM_BLOCK.register("ingot_trader_poi",() -> new IngotTraderBlock(Block.Properties.from(Blocks.IRON_BLOCK)));
