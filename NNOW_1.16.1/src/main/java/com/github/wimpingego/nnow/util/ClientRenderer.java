...
public class ClientRenderer {
	...
	public static void registerBlocks() {
		...
		Block[] blocks = { BlockList.BEEKEEPER_POI.get(),BlockList.OLD_DERPY_POI.get(),BlockList.SEA_TRADER_POI.get(),BlockList.NETHER_TRADER_POI.get(),BlockList.END_LANTERN.get(),BlockList.RSG_HEAD.get()};
