...
public class ItemList {
	...
	public static final RegistryObject<Item> NETHERITE_BERRY = ITEMS.register("netherite_berry", () -> new BlockItem(BlockList.NETHERITE_BERRY_BUSH.get(), new Item.Properties().group(NNOW.NNOW_TAB).food(FoodList.BERRY).isBurnable()));
	...
	public static final RegistryObject<Item> NETHERITE_NUGGET = ITEMS.register("netherite_nugget", () -> new Item(new Item.Properties().group(NNOW.NNOW_TAB).isBurnable()));
	...
	public static final RegistryObject<Item> N_HAMMER = ITEMS.register("netherite_hammer", () -> new NetheriteHammer(ItemTier.NETHERITE, 7, -3.1f, new Item.Properties().group(NNOW.NNOW_TAB).isBurnable()));
	...
	public static final RegistryObject<Item> N_SPADE = ITEMS.register("netherite_spade", () -> new NetheriteSpade(ItemTier.NETHERITE, 2.0f, -3f, new Item.Properties().group(NNOW.NNOW_TAB).isBurnable()));
